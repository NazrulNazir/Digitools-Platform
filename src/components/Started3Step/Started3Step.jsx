...
<div className='my-25'>
    <div className='mb-10'>
        ...
        <p className='text-neutral-500 text-center mt-2'>Start using premium digital tools in minutes, not hours</p>
    </div>
    <div className='md:container px-5 sm:p-0 mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 text-center'>
        <div className='bg-base-300 p-5 pb-8 rounded-xl sm:col-span-1 lg:col-span-1'>
